  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <div class="container-fluid">
          <div class="footer">
            <div class="sort-note">
              <a class="navbar-brand" href="index.html">Will W</a>
              <p>I’m Will Walton, a junior and talented Frontend Developer with web design skills.</p>
              <hr style="margin: 20px 0; color: rgb(82, 82, 82); width: 60%;">
              <span class="contact"><a href="mailto:willw@gwholds.com" class="email">
                <img src="./img/email.png" alt="email me"> &nbsp; &nbsp;
                willw@gwholds.com</a></span>
            </div>
